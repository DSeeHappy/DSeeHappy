                ...
                <div className="relative isolate overflow-hidden pt-14  ">
                    ...
                    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                            <div
                                className="relative rounded-full px-3 py-1 text-sm leading-6 text-white bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
                        ...
                        <div className="text-center">
                            ...
                            <div
                                className=" grid grid-cols-1 divide-y rounded-bl-3xl bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
                                ...
                                <p className="text-center pt-10 m-6 text-2xl leading-8 text-white ">
                                    Passionate about design, testing, and ensuring decisive communication between team
                                    members
                                    and
                                    stakeholders.
                                </p>
